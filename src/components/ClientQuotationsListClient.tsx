...
const STATUS_COLORS: Record<string, string> = {
  ...
  quotation_approved: 'bg-[#1877F2]/10 text-[#1877F2]',
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-5 pb-5 border-b border-gray-100">
        <div>
          ...
          <p className="text-[11px] text-gray-400">
            Sales Agent: <span className="text-[#1877F2] font-bold">{q.salesPerson || '--'}</span>
          </p>
        </div>
        ...
        <div className="flex items-center gap-6 w-full md:w-auto justify-between md:justify-end">
          <div className="text-right">
            ...
            <p className="text-[14px] font-black font-mono text-[#050505]">
              {peso(total)}
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="bg-gray-50 p-3 rounded border border-gray-100 flex flex-col gap-1.5 text-[11px]">
            ...
            <div className="flex justify-between text-gray-500">
              ...
              <span className="font-mono font-bold text-[#1877F2]">{peso(markupTotal)}</span>
            </div>
            ...
            <div className="flex justify-between font-bold text-[#050505] border-t border-gray-200 pt-1 mt-0.5">
