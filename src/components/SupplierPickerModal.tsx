        ...
        <div className="bg-white max-w-md w-full flex flex-col rounded-[2rem] shadow-[0_24px_48px_rgba(0,0,0,0.15)] overflow-hidden ring-1 ring-white/50">
          ...
          <div className="p-4 md:p-6 bg-[#fbfbfd] border-t border-gray-100 shrink-0 flex gap-3">
             ...
             <button 
              ...
              className="flex-1 py-3.5 rounded-full text-[13px] font-medium bg-[#1877F2] text-white hover:bg-[#0A4FB0] disabled:opacity-50 disabled:bg-gray-300 disabled:text-gray-500 transition-colors focus:outline-none shadow-sm"
             >
            ...
            <div className="flex flex-col">
              ...
              {search.trim() && !exactMatchExists && (
                <button
                  ...
                  className="w-full text-left px-6 md:px-8 py-4 border-b border-gray-100 bg-[#1877F2]/[0.03] hover:bg-[#1877F2]/[0.08] transition-colors group focus:outline-none flex items-center gap-4"
                >
                  <div className="w-8 h-8 rounded-full bg-[#1877F2]/10 flex items-center justify-center text-[#1877F2] group-hover:bg-[#1877F2] group-hover:text-white transition-colors shrink-0">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
                      <path d="M12 5v14M5 12h14" />
                    </svg>
                  </div>
                  <div className="overflow-hidden">
                    <p className="font-semibold text-[14px] text-[#1877F2] truncate">
                      Add "{search.trim()}"
                    </p>
                    <p className="text-[11px] font-medium text-[#1877F2]/70 mt-0.5 truncate">
              ...
              {filtered.length === 0 && !search.trim() ? (
                ...
                filtered.map((s) => (
                  ...
                  >
                    <p className="font-semibold text-[14px] text-gray-900 group-hover:text-[#1877F2] transition-colors truncate">
                      {s.name}
                    </p>
                    {s.company && (
