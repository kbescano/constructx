      ...
      <div className="bg-white max-w-lg w-full flex flex-col rounded-[2rem] shadow-[0_24px_48px_rgba(0,0,0,0.15)] overflow-hidden ring-1 ring-white/50 relative">
            ...
            {linkedPOs.map((po) => (
              ...
              >
                ...
                <div className="flex flex-col min-w-0">
                  <span className={`text-[14px] font-semibold truncate transition-colors ${String(keeperId) === String(po.id) ? 'text-[#1877F2]' : 'text-gray-900'}`}>
        ...
        <div className="p-6 md:p-8 bg-white border-t border-gray-100 flex gap-3 shrink-0">
          ...
          <button
            ...
            className="flex-1 py-3.5 rounded-full text-[13px] font-medium bg-[#1877F2] text-white hover:bg-[#0A4FB0] transition-colors focus:outline-none shadow-sm disabled:opacity-40 disabled:bg-gray-300 disabled:text-gray-500"
          >
