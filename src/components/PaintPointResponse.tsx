...
export default function PainPointsResponse() {
  ...
  const P1 = "ConstructX gives you all the power of a ";
  const P2 = "direct supplier";
  const P3 = ", so you can build ";
  const P4 = "quicker than ever";
  const DESC = "Developed in parallel with the largest commercial infrastructure projects, ConstructX was shaped by real construction challenges to provide proven logistics, scale, and pricing transparency.";
  ...
  return (
    <section className="py-20 md:py-32 bg-[#fdfffc] overflow-hidden min-h-screen flex flex-col justify-center">
      <div className="max-w-[1100px] mx-auto px-6 lg:px-20 w-full">
        ...
        >
          <div className="flex items-center gap-2 text-[#050505]/40 mb-6 h-[24px]">
          ...
          <h2 className="text-[28px] md:text-[40px] lg:text-[48px] font-medium tracking-tight text-[#050505] leading-[1.2]">
            {h_r1}
            <span className="text-[#1877F2]">{h_r2}</span>
            {h_r3}
            <span className="text-[#1877F2]">{h_r4}</span>
          </h2>
        </div>
          ...
          {VALUE_PROPS.map((v) => (
            ...
            <div key={v.num} className="flex items-center justify-center w-full h-full">
              ...
              <div style={getCardStyle()} className="w-full h-full origin-center">
                ...
                <div className="group relative h-full bg-[#f8f9f7] rounded-2xl p-8 flex flex-col gap-6 border border-[#050505]/5 cursor-pointer transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] hover:scale-[1.05] hover:shadow-[0_30px_60px_-15px_rgba(20,153,17,0.15)] hover:-translate-y-2 hover:border-[#1877F2]/20">
                  
                  {/* Subtle Glow Background on Hover */}
                  <div className="absolute inset-0 bg-gradient-to-br from-[#1877F2]/[0.04] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl pointer-events-none" />
                  ...
                  <div style={{ opacity: contentOpacity, willChange: "opacity" }} className="flex flex-col gap-6 h-full transition-opacity duration-100 ease-linear">
                    ...
                    <div className="w-12 h-12 rounded-xl bg-[#1877F2]/10 text-[#1877F2] flex items-center justify-center transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-3 shadow-sm relative z-10">
                    ...
                    <div className="relative z-10">
                      <h3 className="text-[16px] md:text-[18px] font-bold text-[#050505] leading-tight mb-3 transition-colors duration-300 group-hover:text-[#1877F2]">
                        {v.title}
                      </h3>
                      <p className="text-[14px] text-[#050505]/60 font-medium leading-relaxed m-0">
                        {v.body}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-0 left-8 right-8 h-[2px] bg-gradient-to-r from-[#1877F2]/0 via-[#1877F2]/40 to-[#1877F2]/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                </div>
              </div>
            </div>
          ))}
        ...
        >
          ...
          <h2 className="text-[32px] md:text-[48px] lg:text-[56px] font-medium tracking-tight text-[#050505] leading-[1.1] mb-8 min-h-[140px] md:min-h-[125px]">
            {r1}
            <span className="text-[#1877F2]">{r2}</span>
            {r3}
            <span className="text-[#1877F2]">{r4}</span>
          </h2>

          <p className="text-[15px] md:text-[18px] text-[#050505]/60 font-medium leading-relaxed max-w-[640px] min-h-[80px]">
            {typedDesc}
          </p>
        </div>
      </div>
