...
export default function ProductsCatalog({
  ...
  return (
    <section className="min-h-screen bg-[#050505] pt-24 md:pt-32 pb-16 md:pb-24 font-sans selection:bg-[#1877F2]/30 relative overflow-x-hidden">
      
      {/* Subtle Background Glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-[#1877F2]/10 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-8 mb-8 md:mb-12">
          ...
          <div className="w-full md:w-[320px] flex-shrink-0 z-20 relative bg-[#0A1420]/80 backdrop-blur-xl border border-[#fdfffc]/10 rounded-xl overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
        ...
        <button
          ...
          className="lg:hidden w-full flex items-center justify-between gap-3 mb-4 px-5 py-3.5 bg-[#0A1420]/80 backdrop-blur-xl border border-[#fdfffc]/10 rounded-xl text-[14px] text-[#fdfffc]"
        >
          <span className="flex items-center gap-2">
            ...
            Filters
            {activeCats.length > 0 && (
              <span className="bg-[#1877F2] text-[#fdfffc] text-[10px] font-bold rounded-full w-5 h-5 flex items-center justify-center">
                {activeCats.length}
              </span>
            )}
          </span>
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
          ...
          <aside
            className={`w-full lg:w-[260px] flex-shrink-0 bg-[#0A1420]/80 backdrop-blur-xl border border-[#fdfffc]/5 rounded-2xl p-6 lg:sticky lg:top-32 overflow-hidden transition-all duration-300
                ...
                return (
                  ...
                  >
                    <div className={`w-4 h-4 rounded-[4px] border flex items-center justify-center transition-all duration-300 flex-shrink-0
                      ${isActive ? 'bg-[#1877F2] border-[#1877F2]' : 'border-[#fdfffc]/20 group-hover:border-[#fdfffc]/40 bg-transparent'}
                    `}>
                      {isActive && (
          ...
          <div className={`flex-1 w-full flex flex-col gap-6 transition-opacity duration-200 ${isPending ? 'opacity-60' : 'opacity-100'}`}>
            ...
            {filteredProducts.length === 0 && (
              <div className="py-16 md:py-24 flex flex-col items-center justify-center text-center bg-[#0A1420]/50 border border-[#fdfffc]/5 rounded-2xl px-4">
              ...
              {filteredProducts.map((product, i) => {
                ...
                return (
                  <ScrollReveal
                    ...
                    direction="none"
                    className="group bg-[#0A1420] hover:bg-[#0c201a] border border-[#fdfffc]/5 hover:border-[#fdfffc]/10 rounded-2xl p-4 md:p-6 flex flex-col transition-all duration-300 h-full"
                  >
                    ...
                    <div className="flex flex-wrap items-center gap-2 mb-3 md:mb-4">
                      ...
                      <span className="bg-[#1877F2]/10 border border-[#1877F2]/20 text-[#2dd4bf] px-2 py-1 rounded-[4px] text-[9px] font-bold uppercase tracking-widest flex items-center gap-1.5">
