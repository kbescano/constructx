...
export default function AddSupplierForm() {
  ...
  const inputClass = 'w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:border-[#1877F2]'
    ...
    <div className="mb-6">
      {!open ? (
        <button
          ...
          className="inline-flex items-center gap-2 text-[12px] font-bold uppercase tracking-[0.1em] px-5 py-2.5 bg-[#0A4FB0] text-white hover:bg-[#050505] transition-colors duration-300"
        >
          + Add Supplier
        </button>
      ) : (
        <div className="bg-white border border-[#050505]/10 p-6 max-w-lg shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-base font-black uppercase tracking-tight text-[#050505]">New Supplier</h3>
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="mt-2 px-6 py-2.5 bg-[#1877F2] text-white font-bold text-sm uppercase tracking-wide hover:bg-[#0A4FB0] transition-colors disabled:opacity-50"
            >
