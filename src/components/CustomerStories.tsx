...
export default function CustomerStories({ stories }: { stories: Story[] }) {
  ...
  return (
    <section className="py-24 md:py-32 bg-[#050505] overflow-hidden relative">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-[#1877F2]/5 blur-[120px] rounded-full pointer-events-none" />
        ...
        <ScrollReveal>
          ...
          <div className="flex flex-col items-center justify-center text-center mb-10 md:mb-12">
            ...
            <h2 className="text-[28px] md:text-[36px] font-medium tracking-tight text-[#fdfffc] leading-none">
              Our customer <span className="text-[#1877F2]">stories</span>
            </h2>
          </div>

          {/* Segmented Tab Navigation */}
          <div className="flex flex-wrap md:flex-nowrap w-full overflow-hidden rounded-t-2xl bg-[#0A1420] border border-[#fdfffc]/10 border-b-0 relative z-10">
            {stories.map((story, i) => {
            ...
            <div className="bg-[#fdfffc] w-full p-8 md:p-12 lg:p-16 shadow-2xl rounded-b-2xl border-x border-b border-[#fdfffc]/10 min-h-[400px]">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14 items-center h-full">
                ...
                <div className="flex flex-col items-start order-2 lg:order-1 h-full justify-center">
                  ...
                  {/* Category Badge */}
                  <span className="inline-flex items-center gap-1.5 bg-[#1877F2]/10 text-[#1877F2] px-2.5 py-1 rounded-[4px] text-[8px] font-bold uppercase tracking-[0.2em] mb-4 md:mb-5">
                  ...
                  {/* Typing Title */}
                  <h3 className="text-[20px] md:text-[28px] font-medium text-[#050505] tracking-tight leading-[1.2] mb-4 min-h-[50px] md:min-h-[70px]">
                    {displayedTitle}
                    {!isTypingDone && <span className="animate-pulse ml-0.5 inline-block w-[2px] h-[20px] md:h-[24px] bg-[#1877F2] translate-y-1"></span>}
                  </h3>

                  {/* Typing Description */}
                  <p className="text-[#050505]/60 font-medium text-[13px] md:text-[14px] leading-relaxed max-w-[420px]">
                    {displayedDesc}
                  </p>
