        ...
        >
          <div className="relative w-full aspect-[4/3] bg-[#f8f9f7] overflow-hidden">
            {m.photo?.url ? (
              ...
              <div className="w-full h-full flex items-center justify-center text-[#050505]/20 text-[10px] font-medium uppercase tracking-widest">
                No Image
              </div>
            )}
          ...
          <div className="flex items-center justify-between mt-4 md:mt-5 gap-2">
            <h3 className="text-[14px] md:text-[15px] font-medium tracking-tight text-[#fff] leading-snug transition-colors duration-300 group-hover:text-[#3D5568]">
              {m.name}
            </h3>
            <span className="flex-shrink-0 flex items-center gap-1 text-[10px] font-medium uppercase tracking-[0.15em] text-[#050505] opacity-100 translate-x-0 md:opacity-0 md:-translate-x-1 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0 group-hover:text-[#3D5568]">
              View
