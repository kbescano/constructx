      ...
      <div className="bg-white max-w-lg w-full max-h-[85vh] flex flex-col rounded-[2rem] shadow-[0_24px_48px_rgba(0,0,0,0.15)] overflow-hidden ring-1 ring-white/50 relative">
        ...
        <div className="p-6 md:p-8 border-b border-gray-100 shrink-0">
          ...
          {(Object.keys(assignmentSummary).length > 0 || lastAssigned) && (
            <div className="mt-4 p-3 bg-[#1877F2]/[0.06] border border-[#1877F2]/20 rounded-xl">
              {lastAssigned && (
                <p className="text-[12px] font-semibold text-[#1877F2] mb-1">
                ...
                return (
                  <label
                    ...
                    className={`flex items-center gap-4 p-4 rounded-xl border cursor-pointer transition-all duration-200 ${
                      selected.has(i)
                        ? 'border-[#1877F2] bg-[#1877F2]/[0.06] shadow-sm'
                  ...
                  >
                    <input
                      ...
                      className="w-4 h-4 accent-[#1877F2] flex-shrink-0 cursor-pointer"
                    />
                    <div className="flex flex-col min-w-0">
                      <span className={`text-[14px] font-semibold truncate transition-colors ${selected.has(i) ? 'text-[#1877F2]' : 'text-gray-900'}`}>
                        {item.qty} {item.unit} &times; {item.description}
                      </span>
                      {currentSupplierName && (
                        <span className={`text-[11px] uppercase tracking-wider font-bold mt-1 ${selected.has(i) ? 'text-[#1877F2]/70' : 'text-amber-600'}`}>
              ...
              {addingNew ? (
                <div className="flex flex-col gap-3 bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-[13px] text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-[#1877F2] focus:ring-1 focus:ring-[#1877F2]/25 transition-all"
                    />
                  </div>
                  <div>
                  ...
                  <div className="flex gap-3 mt-3 pt-4 border-t border-gray-100">
                    ...
                    <button
                      ...
                      className="flex-1 py-3 bg-[#1877F2] text-white font-medium text-[13px] rounded-full hover:bg-[#0A4FB0] transition-colors disabled:opacity-40 shadow-sm"
                    >
                      Create &amp; Assign
                    </button>
                  </div>
                ...
                <div className="flex flex-col gap-3">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-3.5 bg-white border border-dashed border-gray-300 rounded-xl text-[#1877F2] text-[13px] font-semibold hover:border-[#1877F2] hover:bg-[#1877F2]/[0.03] transition-all"
                  >
                      ...
                      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                        {suppliers.map((s) => (
                          <button
                            ...
                            className="w-full flex flex-col text-left px-4 py-3.5 hover:bg-[#1877F2]/[0.04] transition-colors border-b border-gray-100 last:border-0 disabled:opacity-50 focus:outline-none focus:bg-gray-50"
                          >
        ...
        <div className="p-6 md:p-8 bg-white border-t border-gray-100 flex gap-3 shrink-0">
          ...
          {step === 'select-items' && (
            <button
              ...
              className="flex-1 py-3.5 rounded-full text-[13px] font-medium bg-[#1877F2] text-white hover:bg-[#0A4FB0] transition-colors focus:outline-none shadow-sm disabled:opacity-50 disabled:bg-gray-300 disabled:text-gray-500"
            >
          ...
          <button
            ...
            className={`flex-1 py-3.5 rounded-full text-[13px] font-medium transition-colors focus:outline-none shadow-sm disabled:opacity-50 ${
              allAssigned
                ? 'bg-[#1877F2] text-white hover:bg-[#0A4FB0]'
