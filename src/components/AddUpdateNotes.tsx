  ...
  return (
    <div className="mt-4 pt-4 border-t border-gray-100">
      <div className="flex items-center justify-between mb-2">
        ...
        <button
          onClick={() => setOpen((v) => !v)}
          className="text-[10px] font-bold uppercase tracking-wider text-[#1877F2] hover:text-[#0A4FB0] transition-colors"
        >
      ...
      {open && (
        <div className="flex flex-col gap-2 mb-3">
          ...
          <button
            ...
            className="self-end px-4 py-1.5 bg-[#1877F2] text-white text-[10px] font-bold uppercase tracking-wider rounded-lg hover:bg-[#0A4FB0] transition-colors disabled:opacity-50"
          >
  ...
  <ul className="flex flex-col gap-1.5 max-h-[140px] overflow-y-auto list-none m-0 p-0">
    {sorted.map((n, i) => (
      <li key={i} className="flex items-start gap-2 text-[11px] text-gray-700 leading-snug">
        <span className="text-[#1877F2] mt-[3px] flex-shrink-0">&bull;</span>
        <span
