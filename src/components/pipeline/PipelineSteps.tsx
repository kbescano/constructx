      ...
      {confirmSendOpen && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white max-w-md w-full p-5 rounded-2xl shadow-[0_30px_80px_-20px_rgba(1,23,47,0.35)]">
            <div className="w-8 h-[3px] bg-[#1877F2] mb-3" />
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={sendingQuote}
                className="flex-1 py-2 rounded-full text-[12px] font-medium bg-[#1877F2] text-white hover:bg-[#0A4FB0] transition-colors focus:outline-none disabled:opacity-50 shadow-sm"
              >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full sm:w-auto">
              <div className="w-full sm:w-auto text-left">
                ...
                <input
                  ...
                  className="w-full sm:w-[150px] appearance-none px-3 py-1.5 text-[11px] font-medium rounded-lg cursor-pointer focus:outline-none ring-1 ring-inset ring-gray-200 focus:ring-[#1877F2]/40 transition-all bg-white hover:bg-gray-50 text-gray-900 shadow-sm"
                />
              </div>
              <div className="w-full sm:w-auto text-left">
                <label className="block text-[8px] font-semibold uppercase tracking-wide text-gray-400 mb-1 ml-1">Status</label>
                <span className="inline-block w-full sm:w-[120px] text-center px-4 py-1.5 text-[10px] font-medium bg-[#1877F2]/10 text-[#1877F2] rounded-lg shadow-sm">
                  Confirmed
                </span>
              </div>
            </div>
  ...
  return (
    <div className="flex-1 min-w-0 bg-[#fbfbfd] border border-gray-100 rounded-xl p-3.5">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <label className="flex flex-col items-center justify-center w-14 h-14 border-2 border-dashed border-gray-300 rounded-lg hover:border-[#1877F2] hover:bg-[#1877F2]/[0.03] transition-colors cursor-pointer shrink-0">
          <input
            type="file"
          ...
          {uploading ? (
            ...
            <span className="text-[8px] font-semibold uppercase tracking-wide text-gray-400 hover:text-[#1877F2] transition-colors">
              + Add
            </span>
          )}
        </label>
      ...
      <div className="w-full flex flex-col gap-5">
              ...
              return (
                <div key={i} className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-gray-50 pb-2.5 last:border-0 last:pb-0">
                  <div>
                    ...
                    {po && (
                      <p className="text-[10px] text-[#1877F2] font-medium mt-1">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 pb-2.5">
          ...
          <div className="flex flex-col gap-3 w-full sm:w-auto">
            <div className="flex items-center gap-2">
              ...
              />
              {isUpdating && (
                <div className="w-3.5 h-3.5 border-2 border-gray-300 border-t-[#1877F2] rounded-full animate-spin flex-shrink-0" />
              )}
            </div>
            ...
            {(localOrder.paymentStatus === 'partial' || localOrder.paymentStatus === 'paid') && (
              <div className="w-full sm:w-[200px] ml-auto flex flex-col gap-1.5">
                ...
                <select
                  ...
                  disabled={isUpdating}
                  className="w-full appearance-none px-3 py-2 text-[12px] font-medium rounded-xl cursor-pointer focus:outline-none ring-1 ring-inset ring-gray-200 focus:ring-[#1877F2]/40 transition-all bg-gray-50 hover:bg-gray-100 text-gray-900 disabled:opacity-50 disabled:cursor-not-allowed"
                >
        ...
        <div className="border-t border-gray-100 pt-4 mt-1">
          ...
          <p className="text-[10px] text-gray-400 mb-3">
            Upload proof of payment. Both the client's payment to ConstructX and ConstructX's payment to the supplier(s) are required before moving to Step 5. You can add multiple files to each.
          </p>
      ...
      <div className="flex flex-col gap-4 w-full">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-gray-100">
          ...
          <input
            ...
            value={localOrder.targetDeliveryDate ? new Date(localOrder.targetDeliveryDate).toISOString().split('T')[0] : ''}
            onChange={(e) => handleUpdateOrderField?.("targetDeliveryDate", e.target.value || null)}
            className="w-full sm:w-[200px] appearance-none px-3 py-1.5 text-[12px] font-medium rounded-xl cursor-pointer focus:outline-none ring-1 ring-inset ring-gray-200 focus:ring-[#1877F2]/40 transition-all bg-gray-50 hover:bg-gray-100 text-gray-900 shadow-sm"
          />
        </div>
      ...
      <div className="flex flex-col gap-4 w-full">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3.5 bg-[#fbfbfd] rounded-2xl border border-gray-100">
          <div>
            ...
            <p className={`text-[13px] font-semibold tracking-tight ${request.status === "completed" ? "text-[#1877F2]" : "text-amber-600"}`}>
                      ...
                      linkedPOs.map((po: any) => (
                        <div key={po.id} className="flex items-center justify-between p-2 bg-gray-50 rounded-lg border border-gray-100">
                          <span className="text-[11px] font-medium text-gray-800">
                           ...
                           <span className="text-[8px] font-medium tracking-wide px-1.5 py-0.5 bg-[#1877F2]/10 text-[#1877F2] rounded flex-shrink-0">
                             {po.status}
                           </span>
                        </div>
                      ))
