  ...
  return (
    <div className="mt-6 border-t border-gray-100 pt-5">
      ...
      <div className="w-full overflow-x-auto pb-4">
        <div className="quotation-print-doc bg-white border border-gray-200 rounded-2xl p-6 text-[#050505] min-w-[794px] shadow-sm">
          <div className="flex flex-row justify-between items-start gap-3 mb-4">
            <div className="flex gap-1.5 items-center">
              <div className="relative w-36 h-36 flex-shrink-0 overflow-hidden">
                <Image src="/branding/constructx_logo.png" alt="ConstructX Trading Corp" fill className="object-contain scale-[1.1]" />
              </div>
              <div>
                <h2 className="text-lg font-black leading-none text-[#0A4FB0] tracking-tight">CONSTRUCTX</h2>
                <p className="text-[10px] font-bold tracking-[0.2em] text-[#050505] mt-0 mb-1.5">TRADING CORPORATION</p>
                <div className="w-full max-w-[200px] h-[2px] bg-[#1877F2] mb-1.5" />
                <p className="text-[8px] font-bold text-[#0A4FB0] leading-snug max-w-[200px] m-0">
                  UNIT 4B, METRO LOGISTICS HUB, INDUSTRIAL AVE, BRGY. SAN ISIDRO, 4103 CAVITE, PHILIPPINES
                </p>
                <p className="text-[8px] font-bold text-[#0A4FB0] m-0 mt-1">0917-000-0000 / 0917-000-0001 / 046-000-0000</p>
                <p className="text-[8px] font-bold text-[#0A4FB0] m-0 mt-1">SALES@CONSTRUCTX.DEMO</p>
              </div>
            </div>
            <div className="text-right w-auto">
              <h3 className="text-lg font-bold text-[#3D5568] mb-1">FORMAL QUOTATION</h3>
          ...
          <div className="mb-3">
            <div className="bg-[#3D5568] text-white text-[10px] font-bold uppercase tracking-wide px-2 py-1 rounded-sm">Customer</div>
          ...
          <div>
            <table className="w-full text-[10px] mb-2 border-collapse">
              <thead>
                <tr className="bg-[#3D5568] text-white text-[10px] uppercase tracking-wide">
          ...
          <div className="flex justify-end mt-8 mb-4">
            <table className="text-[10px] w-full max-w-[240px]">
              <tbody>
                <tr>
                  <td className="py-1 px-2 bg-[#E7F0FE] rounded-l-sm">Subtotal</td>
                  <td className="py-1 px-2 bg-[#E7F0FE] text-right font-mono rounded-r-sm">{peso(subtotal)}</td>
                </tr>
                {discountAmount > 0 && (
                  <tr>
                ...
                <tr className="border-t-2 border-[#3D5568]">
                  <td className="py-1 px-2 font-bold text-[11px] bg-[#E7F0FE] rounded-l-sm">TOTAL</td>
                  <td className="py-1 px-2 font-bold text-[11px] text-right font-mono bg-[#E7F0FE] rounded-r-sm">{peso(total)}</td>
                </tr>
              </tbody>
            </table>
          </div>
