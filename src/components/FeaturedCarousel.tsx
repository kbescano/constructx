  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className={`absolute inset-0 rounded-3xl overflow-hidden bg-gradient-to-b from-[#0A1420] to-[#050505] border border-[#fdfffc]/10 flex flex-col justify-end
          shadow-[0_4px_20px_rgba(0,0,0,0.4)] lg:group-hover:shadow-[0_20px_50px_rgba(20,153,17,0.4)] lg:group-hover:border-[#1877F2]/40
      ...
      >
        ...
        {isFeatured && featuredVideo ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-[#030507] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#0A1420] to-[#030507] pointer-events-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#010605] via-[#050505]/70 to-transparent pointer-events-none transition-colors duration-700 lg:group-hover:via-[#050505]/40" />

        {/* Text Content */}
        <div className="relative z-10 p-6 md:p-8 flex flex-col justify-end h-full w-full pointer-events-none">
          {isFeatured && (
            <div className="mb-4">
              <span className="inline-flex items-center gap-2 bg-[#1877F2]/10 border border-[#1877F2]/30 backdrop-blur-md text-[#2dd4bf] px-3.5 py-1.5 rounded-full text-[9px] font-black uppercase tracking-[0.25em] shadow-[0_0_15px_rgba(20,153,17,0.2)]">
          ...
          <div className="overflow-hidden h-10 lg:h-0 lg:group-hover:h-10 transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] mt-2">
            <span className="inline-flex items-center gap-2.5 text-[10px] md:text-[11px] font-bold uppercase tracking-[0.2em] text-[#fdfffc] translate-y-0 lg:translate-y-6 lg:group-hover:translate-y-0 transition-transform duration-500 delay-100">
              Browse Category
              <span className="flex items-center justify-center w-6 h-6 rounded-full bg-[#1877F2] text-white lg:-translate-x-3 lg:group-hover:translate-x-1 transition-transform duration-500 shadow-[0_0_10px_rgba(20,153,17,0.4)]">
...
export default function FeaturedCarousel({
  ...
  return (
    <div className="w-full flex flex-col gap-10 md:gap-16 pt-4 bg-[#050505]">
