      ...
      <div className="flex items-center justify-between gap-2 px-4 py-3 bg-amber-50/60 border-b border-amber-100">
        ...
        {isAdmin && (
          <button
            ...
            className="text-[10px] font-bold uppercase tracking-wider text-white bg-[#050505] px-3 py-1.5 rounded-full hover:bg-[#0a2947] transition-colors"
          >
            + New Action Item
          </button>
        )}
      ...
      >
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 text-[12px] border border-gray-200 rounded-lg focus:outline-none focus:border-[#1877F2] bg-white"
          >
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-3 py-2 text-[12px] border border-gray-200 rounded-lg focus:outline-none focus:border-[#1877F2] resize-none"
          />
        </div>
        ...
        <button
          ...
          className="self-end px-4 py-1.5 bg-[#1877F2] text-white text-[11px] font-bold uppercase tracking-wider rounded-lg hover:bg-[#0A4FB0] transition-colors disabled:opacity-50"
        >
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-[200] flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="bg-[#050505]/5 rounded-xl p-2.5 text-[12px] text-gray-800 leading-relaxed">
            ...
            {item.comments.map((c, i) => (
              <div
                ...
                className={`rounded-xl p-2.5 text-[12px] leading-relaxed ${
                  c.authorRole === 'admin' ? 'bg-[#050505]/5 text-gray-800' : 'bg-emerald-50 text-gray-800'
                }`}
              >
                <div className="flex items-center justify-between mb-1 gap-2">
                  <span className="text-[10px] font-bold uppercase tracking-wide text-gray-500">
          ...
          <>
            ...
            <div className="flex gap-2 justify-end">
              ...
              <button
                onClick={() => send('solve')}
                disabled={sending}
                className="px-4 py-1.5 bg-[#1877F2] text-white text-[11px] font-bold uppercase tracking-wider rounded-lg hover:bg-[#0A4FB0] transition-colors disabled:opacity-50"
              >
                Mark as Solved
              </button>
            </div>
