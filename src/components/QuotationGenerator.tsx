...
const BASE_TERMS = [
  ...
  "Ownership of products shall remain with ConstructX Trading Corp. until full payment is received. Risk passes to the buyer upon delivery or collection.",
...
export default function QuotationGenerator({
  ...
  const inputClass =
    "w-full px-3.5 py-2.5 border border-gray-300 rounded text-sm text-[#050505] placeholder:text-gray-400 hover:border-[#050505]/30 focus:outline-none focus:border-[#1877F2] focus:ring-1 focus:ring-[#1877F2]/25 transition-all duration-200 disabled:bg-gray-50 disabled:text-gray-500 disabled:cursor-not-allowed";
  const labelClass =
    ...
    <div className="max-w-5xl mx-auto p-4 md:p-6 bg-[#fdfffc]">
      ...
      {reminderOpen && !isLocked && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white max-w-md w-full p-6 shadow-[0_30px_80px_-20px_rgba(1,23,47,0.35)]">
            ...
            />
            <h2 className="text-base font-black uppercase tracking-tight text-[#050505] mb-1">
            ...
            <ul className="flex flex-col gap-1.5 mb-6 max-h-[220px] overflow-y-auto">
              {getMissingFields().map((f, i) => (
                <li
                  key={i}
                  className="flex items-center gap-2 text-sm text-[#050505]"
                >
                  <span
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`flex-1 py-2.5 border-2 font-bold text-sm uppercase tracking-wide transition-colors ${
                  pendingStatus === "pending_approval"
                    ...
                    : "border-[#3D5568] text-[#3D5568] hover:bg-[#3D5568] hover:text-white"
                }`}
              >
                Go Back and Fix
              </button>
              ...
              {pendingStatus !== "pending_approval" && (
                <button
                  ...
                  className="flex-1 py-2.5 bg-[#1877F2] text-white font-bold text-sm uppercase tracking-wide hover:bg-[#0A4FB0] transition-colors"
                >
                  Save Anyway
                </button>
              )}
      ...
      <div className="print:hidden">
        <div className="mb-8">
          {showBackToList && (
            <button
              ...
              className="inline-flex items-center gap-1.5 text-[12px] font-bold uppercase tracking-[0.1em] text-[#050505]/50 hover:text-[#1877F2] transition-colors mb-4 focus:outline-none"
            >
              &larr;{" "}
          ...
          <h1 className="text-2xl font-black uppercase tracking-tight text-[#050505] mb-2">
        ...
        <div className="flex items-center gap-3 mb-1">
          <h2 className="text-base font-black uppercase tracking-tight text-[#050505]">
            Line Items
          </h2>
                ...
                <div className="bg-amber-50/60 border border-amber-100 rounded-md p-2.5">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2 items-center">
                    ...
                    <div>
                      ...
                      <div className="w-full px-3.5 py-2.5 border border-gray-200 rounded text-sm bg-gray-50 text-[#3D5568] font-bold font-mono">
                        {peso(computedPrice)}
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="w-full px-3.5 py-2.5 border border-gray-200 rounded text-sm bg-gray-50 text-[#050505] font-bold font-mono">
                ...
                {!isLocked && (
                  <div className="flex flex-wrap items-center gap-3 mt-3 pt-3 border-t border-gray-100">
                    <label className="text-xs text-gray-500 flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <span className="px-3 py-1.5 border border-dashed border-gray-300 rounded text-[#3D5568] hover:border-[#1877F2] hover:bg-[#1877F2]/[0.03] transition-all duration-200 whitespace-nowrap">
                        {item.imageDataUrl
                          ? "Change spec image"
        ...
        {!isLocked && (
          <button
            ...
            className="text-sm text-[#3D5568] border border-dashed border-gray-300 rounded px-4 py-2.5 mb-8 hover:border-[#1877F2] hover:bg-[#1877F2]/[0.03] transition-all duration-200"
          >
            + Add line item
          </button>
        )}
        ...
        <div className="bg-[#f4f6f2] border border-[#1877F2]/20 rounded-lg px-5 py-4 mb-4 flex flex-col gap-2.5">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wide text-[#050505]/60">
              Total
            </span>
            <span className="text-lg font-black text-[#050505] font-mono">
              {peso(total)}
            </span>
          </div>
          <div className="flex items-center justify-between pt-2.5 border-t border-[#1877F2]/15">
            <span className="text-xs font-bold uppercase tracking-wide text-[#050505]/60">
              Mark up
            </span>
            <span className="text-lg font-black text-[#1877F2] font-mono">
              {peso(totalMarkup)}
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-4 [&>button]:w-full sm:[&>button]:w-auto">
          {!isLocked ? (
              ...
              <button
                ...
                className={`px-8 py-3 rounded border-2 font-bold disabled:opacity-50 transition-all duration-300 hover:-translate-y-0.5 ${
                  saving === "saved"
                    ...
                    : "border-[#3D5568] text-[#3D5568] hover:shadow-[0_10px_30px_-10px_rgba(16,57,0,0.4)]"
                }`}
              >
                {saving === "saving"
                  ? "Saving..."
            ...
            <button
              ...
              className="px-8 py-3 rounded bg-[#3D5568] text-white font-bold hover:bg-[#050505] hover:-translate-y-0.5 hover:shadow-[0_10px_30px_-10px_rgba(1,23,47,0.4)] transition-all duration-300"
            >
              Print / Save as PDF
            </button>
          )}
      ...
      <div className="w-full overflow-x-auto pb-4">
        <div className="quotation-print-doc bg-white border border-gray-200 rounded p-8 print:border-0 print:p-0 print:rounded-none text-[#050505] min-w-[794px] shadow-[0_20px_60px_-20px_rgba(1,23,47,0.15)] print:shadow-none">
          <div className="flex flex-row justify-between items-start gap-3 mb-4">
            <div className="flex gap-1.5 items-center">
              ...
              <div>
                <h2 className="text-xl font-black leading-none text-[#0A4FB0] tracking-tight">
                  CONSTRUCTX
                </h2>
                <p className="text-[11px] font-bold tracking-[0.2em] text-[#050505] mt-0 mb-1.5">
                  TRADING CORPORATION
                </p>
                <div className="w-full max-w-[240px] h-[2px] bg-[#1877F2] mb-1.5" />
                <p className="text-[9px] font-bold text-[#0A4FB0] leading-snug max-w-[240px] m-0">
                  UNIT 4B, METRO LOGISTICS HUB, INDUSTRIAL AVE,
                  BRGY. SAN ISIDRO, 4103 CAVITE, PHILIPPINES
                </p>
                <p className="text-[9px] font-bold text-[#0A4FB0] m-0 mt-1">
                  0917-000-0000 / 0917-000-0001 / 046-000-0000
                </p>
                <p className="text-[9px] font-bold text-[#0A4FB0] m-0 mt-1">
            ...
            <div className="text-right w-auto">
              <h3 className="text-xl font-bold text-[#3D5568] mb-1">
                FORMAL QUOTATION
              </h3>
          ...
          <div className="mb-3">
            <div className="bg-[#3D5568] text-white text-xs font-bold uppercase tracking-wide px-3 py-1">
              Customer
            </div>
          ...
          <div>
            <table className="w-full text-xs mb-2 border-collapse table-fixed">
              <thead>
                <tr className="bg-[#3D5568] text-white text-xs uppercase tracking-wide">
                    ...
                    <td className="py-1.5 px-2 border-b border-gray-100 align-top">
                      <div className="flex flex-wrap items-start gap-x-3 gap-y-1">
                        <div className="flex flex-wrap items-baseline gap-x-1.5 min-w-0">
                          <span className="font-bold text-[15px] text-[#050505] leading-snug break-words">
                            {item.description || "--"}
                          </span>
          ...
          <div className="flex justify-end mt-10 mb-4">
            <table className="text-xs w-full max-w-[280px]">
              <tbody>
                <tr>
                  <td className="py-1 px-2 bg-[#E7F0FE]">Subtotal</td>
                  <td className="py-1 px-2 bg-[#E7F0FE] text-right font-mono">
                    {peso(subtotal)}
                  </td>
                </tr>
                {hasDiscount && (
                ...
                <tr className="border-t-2 border-[#3D5568]">
                  <td className="py-1.5 px-2 font-bold text-sm bg-[#E7F0FE]">
                    TOTAL
                  </td>
                  <td className="py-1.5 px-2 font-bold text-sm text-right font-mono bg-[#E7F0FE]">
                    ₱{peso(total)}
                  </td>
                </tr>
              </tbody>
