...
export default function SupplierPOGenerator({
  ...
  return (
    <div className="w-full max-w-[1000px] mx-auto p-4 md:p-8 bg-[#fbfbfd] min-h-screen antialiased print:min-h-0 print:p-0 print:m-0 print:bg-white">
          ...
          <div className="bg-white max-w-md w-full p-8 rounded-[2rem] shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="w-full sm:flex-1 py-3 rounded-full bg-[#1877F2] text-white font-medium text-[12px] hover:bg-[#0A4FB0] transition-colors shadow-sm"
              >
                Save Anyway
              </button>
            </div>
      ...
      <div className="print:hidden w-full">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 mb-8">
            ...
            <div className="col-span-1 md:col-span-2 mt-4 pt-6 border-t border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <button
                ...
                className="w-full sm:w-auto text-[11px] font-semibold px-4 py-2 bg-[#1877F2]/10 text-[#1877F2] hover:bg-[#1877F2]/20 rounded-full transition-colors"
              >
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 mt-4 pt-4 border-t border-gray-200/60">
                  <label className="text-[11px] font-medium text-gray-500 flex items-center gap-2 cursor-pointer w-full sm:w-auto">
                    ...
                    />
                    <span className="w-full sm:w-auto text-center px-4 py-2 border border-dashed border-gray-300 rounded-lg text-[#1877F2] hover:border-[#1877F2] hover:bg-[#1877F2]/5 transition-all duration-200">
                      {item.imageDataUrl
                        ? "Change spec image"
                        : "+ Add spec image"}
                    </span>
          ...
          <button
            ...
            className="text-[12px] font-medium text-[#1877F2] border border-dashed border-gray-300 rounded-xl px-5 py-3 mb-8 hover:border-[#1877F2] hover:bg-[#1877F2]/5 transition-all w-full md:w-auto"
          >
            + Add Line Item
          </button>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-8 w-full">
          ...
          <button
            ...
            className="w-full sm:w-auto px-8 py-3.5 rounded-full bg-[#1877F2] border border-transparent text-white font-medium text-[13px] hover:bg-[#0A4FB0] transition-all duration-300 shadow-sm"
          >
            Print / Save as PDF
          </button>
        </div>
      ...
      <div className="po-print-doc bg-white border border-gray-200 rounded-[1.5rem] md:rounded-3xl p-4 sm:p-6 md:p-10 print:border-0 print:p-10 print:rounded-none text-[#050505] shadow-sm print:shadow-none print:w-full print:max-w-none overflow-hidden print:overflow-visible">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-6 print:gap-3 mb-6 print:mb-4">
          <div className="flex gap-2 sm:gap-3 items-center">
            ...
            <div>
              <h2 className="text-sm sm:text-lg md:text-xl font-black leading-none text-[#0A4FB0] tracking-tight">
                CONSTRUCTX
              </h2>
              <p className="text-[7px] sm:text-[9px] md:text-[11px] font-bold tracking-[0.2em] text-[#050505] mt-0 mb-1 sm:mb-1.5">
                TRADING CORPORATION
              </p>
              <div className="w-full max-w-[120px] sm:max-w-[200px] md:max-w-[240px] h-[2px] bg-[#1877F2] mb-1 sm:mb-1.5" />
              <p className="text-[6px] sm:text-[8px] md:text-[9px] font-bold text-[#0A4FB0] leading-snug max-w-[150px] sm:max-w-[200px] md:max-w-[240px] m-0">
                UNIT 4B, METRO LOGISTICS HUB, INDUSTRIAL AVE, BRGY. SAN ISIDRO,
                4103 CAVITE, PHILIPPINES
              </p>
              <p className="text-[6px] sm:text-[8px] md:text-[9px] font-bold text-[#0A4FB0] m-0 mt-1">
          ...
          <div className="text-left sm:text-right w-full sm:w-auto border-t sm:border-0 border-gray-100 pt-3 sm:pt-0 mt-2 sm:mt-0">
            <span className="inline-block bg-[#3D5568] text-white text-[10px] sm:text-sm print:text-[11px] font-bold tracking-wide px-3 sm:px-4 print:px-3 py-1 sm:py-1.5 print:py-1 mb-2 sm:mb-3 print:mb-2">
              PURCHASE ORDER
            </span>
        ...
        <div className="mb-4 sm:mb-6 print:mb-4">
          <div className="bg-[#3D5568] text-white text-[10px] sm:text-xs font-bold uppercase tracking-wide px-2 sm:px-3 py-1 print:py-0.5">
            Supplier
          </div>
        ...
        <div className="overflow-x-auto print:overflow-visible">
          <table className="w-full text-[10px] sm:text-sm print:text-xs mb-2 border-collapse min-w-[500px] md:min-w-full print:min-w-0">
            <thead>
              <tr className="bg-[#3D5568] text-white text-[9px] sm:text-xs print:text-[10px] uppercase tracking-wide">
        ...
        <div className="flex justify-end mt-6 sm:mt-10 print:mt-10 mb-6 sm:mb-10 print:mb-10">
          <table className="text-[10px] sm:text-sm print:text-xs w-full max-w-[200px] sm:max-w-[280px]">
            <tbody>
              <tr>
                <td className="py-1.5 sm:py-2.5 print:py-1 px-2 sm:px-4 print:px-2 bg-[#E7F0FE]">
                  SUBTOTAL
                </td>
                <td className="py-1.5 sm:py-2.5 print:py-1 px-2 sm:px-4 print:px-2 bg-[#E7F0FE] text-right font-mono">
                  ₱{peso(subtotal)}
                </td>
              </tr>
              <tr className="border-t-2 border-[#3D5568]">
                <td className="py-2 sm:py-3.5 print:py-1.5 px-2 sm:px-4 print:px-2 font-bold text-[11px] sm:text-base print:text-[13px] bg-[#E7F0FE]">
                  TOTAL
                </td>
                <td className="py-2 sm:py-3.5 print:py-1.5 px-2 sm:px-4 print:px-2 font-bold text-[11px] sm:text-base print:text-[13px] text-right font-mono bg-[#E7F0FE]">
                  ₱{peso(total)}
                </td>
              </tr>
            </tbody>
        ...
        <div className="mt-6 sm:mt-10 print:mt-4 mb-6 sm:mb-10 print:mb-4 text-[9px] sm:text-[11px] print:text-[8px] leading-snug sm:leading-relaxed print:leading-tight print:break-inside-avoid">
          <div className="bg-[#3D5568] text-white text-[9px] sm:text-xs print:text-[9px] font-bold uppercase tracking-wide px-2 sm:px-3 py-1 sm:py-1.5 print:py-1 mb-2 sm:mb-3 print:mb-1.5">
            Terms and Condition
          </div>
