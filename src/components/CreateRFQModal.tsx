...
const fieldClass =
  "w-full px-4 py-3.5 bg-white border border-[#050505]/15 text-[14px] text-[#050505] placeholder:text-[#050505]/35 focus:outline-none focus:border-[#1877F2] transition-colors duration-300 rounded-lg shadow-sm";
...
export default function CreateRFQModal({ products }: { products: Product[] }) {
  ...
  return (
    <>
      <button
        onClick={openModal}
        className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#050505] text-white rounded-lg text-[11px] font-bold uppercase tracking-widest hover:bg-[#1877F2] transition-colors shadow-md hover:shadow-lg"
      >
        <svg
          width="14"
          height="14"
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-[#050505]/40 backdrop-blur-sm transition-opacity">
          <div className="bg-white w-full max-w-[680px] max-h-[90vh] overflow-y-auto rounded-2xl shadow-2xl relative custom-scrollbar flex flex-col">
            ...
            {view === "picker" && (
              <div className="p-6 sm:p-10 flex flex-col h-full">
                <div className="mb-6 pr-8 shrink-0">
                  <h2 className="text-[22px] font-bold tracking-tight text-[#050505] mb-1">
                    ...
                    <div className="max-h-[350px] overflow-y-auto custom-scrollbar">
                      {clients.map((c) => (
                        <button
                          ...
                          className="w-full text-left px-5 py-4 hover:bg-[#1877F2]/[0.05] transition-colors border-b border-gray-100 last:border-0 group"
                        >
                          <p className="font-bold text-[#050505] text-[13px] group-hover:text-[#1877F2] transition-colors">
                            {c.name}
                          </p>
                          {(c.company || c.phone) && (
                ...
                <div className="mt-auto pt-2 shrink-0">
                  <button
                    ...
                    className="w-full py-3.5 border-2 border-gray-200 rounded-xl text-[11px] font-bold uppercase tracking-widest text-gray-500 hover:border-[#050505] hover:text-[#050505] transition-all bg-gray-50 hover:bg-white"
                  >
                    Start Blank Instead
                  </button>
                </div>
            ...
            {view === "done" && (
              <div className="p-10 md:p-16 text-center my-auto flex flex-col items-center justify-center h-full">
                <div className="w-12 h-[3px] bg-[#1877F2] mx-auto mb-8" />
                <h2 className="text-[28px] md:text-[32px] font-black uppercase tracking-tight text-[#050505] mb-4">
                  Inquiry created.
                </h2>
                <p className="text-[15px] text-[#050505]/60 font-medium max-w-[400px] mx-auto mb-10">
                  The project details have been recorded.
                </p>
                <button
                  onClick={closeModal}
                  className="px-8 py-3 bg-[#050505] text-white text-[11px] font-bold uppercase tracking-widest hover:bg-[#1877F2] transition-colors rounded-lg"
                >
                  Done
                </button>
              </div>
            ...
            {(view === "form" || view === "submitting") && (
              <div className="p-6 sm:p-10">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  {preselectedMaterial && (
                    <p className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.15em] text-[#3D5568] m-0 bg-green-50 p-3 rounded-md">
                  ...
                  {/* Products Section */}
                  <div className="border-t border-[#050505]/10 pt-8 mt-2">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
                      <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#050505] m-0">
                        Products Needed
                      </p>
                      ...
                      <label className="flex items-center gap-2.5 cursor-pointer group">
                        <div className="relative flex items-center justify-center w-5 h-5">
                          ...
                          />
                          <div className="w-full h-full border-2 border-[#050505] rounded-sm bg-white peer-checked:bg-[#050505] transition-colors flex items-center justify-center">
                            {isProductsTBC && (
                              <svg
                        ...
                        <span className="text-[11px] font-bold uppercase tracking-widest text-[#050505]/60 group-hover:text-[#050505] transition-colors">
                          To be confirmed?
                        </span>
                      </label>
                    </div>
                    ...
                    {isProductsTBC ? (
                      ...
                      <div className="flex flex-col gap-5">
                              ...
                              <div className="flex flex-col sm:flex-row gap-3 items-center w-full">
                                <div className="w-full sm:w-[55%] relative">
                                  <select
                                    ...
                                    className="w-full px-4 py-3.5 bg-white border border-gray-200 text-[14px] text-[#050505] focus:outline-none focus:border-[#1877F2] transition-colors duration-300 rounded-lg shadow-sm appearance-none pr-9 bg-[url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2212%22 height=%2212%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22%2301172f%22 stroke-width=%222%22><path d=%22M6 9l6 6 6-6%22/></svg>')] bg-no-repeat bg-[right_14px_center]"
                                  >
                                    {products.map((m) => (
                                ...
                                <div className="w-full sm:w-[45%] flex items-center gap-2">
                                  <div className="flex-1 flex items-center bg-white border border-gray-200 rounded-lg shadow-sm px-4 py-3.5 focus-within:border-[#1877F2] transition-colors duration-300">
                                    <input
                                      type="number"
                                      min={1}
                                      required
                                      ...
                                      className="w-full text-center text-[14px] text-[#050505] focus:outline-none bg-transparent"
                                      aria-label="Quantity"
                                    />
                        ...
                        <button
                          type="button"
                          onClick={addItem}
                          className="mt-2 w-full border border-dashed border-gray-200 px-4 py-4 text-[11px] font-bold uppercase tracking-[0.15em] text-gray-400 hover:border-[#050505]/30 hover:text-[#050505] hover:bg-gray-50 transition-all duration-300 rounded-lg"
                        >
                          + Add Another Product
                        </button>
                      </div>
                  ...
                  <div className="border-t border-[#050505]/5 pt-8 mt-2">
                  ...
                  <button
                    ...
                    className="relative flex items-center justify-center w-full bg-white text-[#3D5568] py-4 overflow-hidden group cursor-pointer border-2 border-[#1877F2] rounded-lg disabled:opacity-60 mt-4 transition-colors duration-300 shadow-sm hover:shadow-md"
                  >
