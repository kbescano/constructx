...
export default function ExportCenterClient({
  ...
  return (
    <div className="max-w-[900px] mx-auto py-6">
      <div className="mb-8">
        <h1 className="text-2xl font-black uppercase tracking-tight text-[#050505] mb-1">Export Center</h1>
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-white border border-gray-200 rounded-2xl p-5">
          ...
          <p className="text-2xl font-black text-[#050505]">{safeOrders.length}</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-2xl p-5">
          <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-2">Gross Revenue</p>
          <p className="text-2xl font-black text-[#050505] font-mono">{peso(totals.gross)}</p>
        </div>
      </div>
      ...
      <button
        ...
        className="w-full sm:w-auto px-8 py-3.5 bg-[#1877F2] text-white text-[12px] font-bold uppercase tracking-widest rounded-xl hover:bg-[#0A4FB0] transition-colors disabled:opacity-50 shadow-sm"
      >
