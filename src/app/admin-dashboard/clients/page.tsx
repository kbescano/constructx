...
export default async function ClientsPage({
  ...
  const thClass = "bg-[#050505] text-white text-[9px] font-bold uppercase tracking-widest px-3.5 py-3 text-left border-r border-[#1a2d42] last:border-0"
  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto py-6 overflow-x-hidden">
      <div className="mb-8">
        <div className="w-10 h-[3px] bg-[#1877F2] mb-4" />
        <h1 className="text-[26px] md:text-[32px] font-black uppercase tracking-tight text-[#050505] leading-none mb-2">
          Clients
        </h1>
            ...
            <table className="w-full table-fixed border-collapse text-left">
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {docs.map((c: any, i: number) => {
                  ...
                  return (
                    <tr key={c.id} className={`${zebra} hover:bg-[#1877F2]/[0.03] transition-colors`}>
                      <td className={tdClass}>
                        <span className="font-bold text-[#050505] uppercase block leading-tight">
          ...
          <div className="sm:hidden flex flex-col divide-y divide-gray-200">
            {docs.map((c: any) => (
              <div key={c.id} className="bg-white">
                <div className="bg-[#050505] text-white px-4 py-2.5">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 px-4 py-4 border-t border-gray-200 bg-gray-50">
              {hasPrevPage ? (
                <Link
                  ...
                  className="text-[10px] font-bold uppercase tracking-wider px-4 py-2 rounded border bg-white border-gray-200 text-gray-600 hover:border-[#050505] hover:text-[#050505] transition-all"
                >
                  &larr; Prev
                </Link>
              ) : (
