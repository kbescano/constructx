      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="text-[10px] font-bold uppercase tracking-wider text-[#0A4FB0] hover:text-[#1877F2] transition-colors"
          >
            &larr; View Clients
          </Link>
          <Link
            href="/admin-dashboard/client-quotation?new=true"
            className="text-[10px] font-bold uppercase tracking-wider px-4 py-2 bg-[#050505] text-white rounded hover:bg-[#1877F2] transition-colors"
          >
            + Create New
          </Link>
        </div>
