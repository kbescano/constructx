  ...
  return (
    <>
      ...
      <div className="max-w-[1200px] mx-auto py-6 print:hidden">
        <div className="mb-8">
          <h1 className="text-2xl font-black uppercase tracking-tight text-[#050505] mb-1">
                ...
                <div key={o.id} className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 flex flex-col gap-4">
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex flex-col gap-1">
                      <span className="font-mono text-[14px] font-black text-[#050505]">{o.orderNumber}</span>
                      <span className={`inline-block text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded w-fit ${
                        ...
                        o.fulfillmentStatus === 'delivered' ? 'bg-[#1877F2]/10 text-[#1877F2]' :
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 border border-gray-100">
                    <div className="text-[12px] font-bold text-[#050505] mb-0.5">{o.customerName}</div>
                      ...
                      <ul className="flex flex-col gap-1.5">
                        {o.items.map((item: any, idx: number) => (
                          <li key={idx} className="text-[11px] text-gray-700 leading-snug break-words">
                            <span className="font-bold text-[#050505] mr-1.5">{Number(item.qty) || 0} {item.unit || 'x'}</span>
                      ...
                      <div className="pt-2 mt-2 border-t border-gray-100 flex flex-col gap-1.5">
                        {o.orderPOs.map((po: any) => (
                          <div key={po.id} className="flex items-start">
                            <span className="text-[9px] font-bold uppercase tracking-widest text-[#1877F2] bg-[#1877F2]/5 border border-[#1877F2]/10 px-1.5 py-0.5 rounded leading-tight inline-block">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                      ...
                      {o.hasItinerary ? (
                        <div className="flex flex-col items-start gap-0.5">
                          ...
                          <span className={`text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded mt-0.5 ${
                            o.itin.status === 'delivered' ? 'bg-[#1877F2]/10 text-[#1877F2]' : 'bg-amber-50 text-amber-600 border border-amber-100'
                          }`}>
                    ...
                    <button
                      ...
                      className={`inline-flex items-center justify-center px-4 py-2.5 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors shadow-sm ${
                        o.hasItinerary 
                          ? 'bg-white border border-gray-200 text-[#050505] hover:bg-gray-50'
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {enrichedOrders.map((o: any) => (
                      <tr key={o.id} className="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td className="px-5 py-4 align-top">
                          <span className="font-mono text-[12px] font-bold text-[#050505] block mb-1">{o.orderNumber}</span>
                          ...
                          <div className="flex flex-col gap-2.5">
                            {o.items && o.items.length > 0 ? (
                              <ul className="flex flex-col gap-1.5">
                                {o.items.map((item: any, idx: number) => (
                                  <li key={idx} className="text-[11px] text-gray-700 leading-snug break-words">
                                    <span className="font-bold text-[#050505] mr-1.5">
                        ...
                        <td className="px-5 py-4 align-top">
                          <div className="text-[13px] font-bold text-[#050505] mb-0.5">{o.customerName}</div>
      ...
      {trackOrderId && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 sm:p-6 bg-[#050505]/40 backdrop-blur-sm print:static print:bg-transparent print:p-0 print:block">
